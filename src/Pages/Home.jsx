...
const TECH_STACK = ["React", "Next.js", "Node.js", "Javascript", "Tailwind", "HTML", "CSS", "SQL", "CodeIgniter", "Laravel"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/rizkyrainda/" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/rizky-maulana-rainda/" },
  { icon: Instagram, link: "https://www.instagram.com/rizkyrainda/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Versatile Fullstack Web Developer with expertise in PHP, HTML, CSS, and JavaScript React.js, Node.js, Next.js, using CodeIgniter and Laravel frameworks to build dynamic web applications.
                </p>
