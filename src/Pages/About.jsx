        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Versatile Fullstack Web Developer with expertise in PHP, HTML, CSS, and JavaScript, using CodeIgniter and Laravel frameworks to build dynamic web applications. Skilled in managing relational databases including MySQL, PostgreSQL, and SQL Server. Experienced in collaborative development with GitHub, GitLab, and TortoiseGit. Also knowledgeable in other languages such as Delphi, VB.Net, C++, Java Complemented by a solid background in IT support and data analysis.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1eOOIP4yP-hqaQT0iXC65FYCeBlYPrho4/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
